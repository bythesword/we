...
// class Vector2 extends vec<Vector2> {
class Vector2<T extends Vector2<T>> {
    vec: Vec2;
    ...
    clamp(min = 0, max = 1, dst?: Vector2<T>) {
        if (dst) {
    ...
    add(a: Vector2<T>, b: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    addScaled(a: Vector2<T>, b: Vector2<T>, scale: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    angle(a: Vector2<T>, b: Vector2<T>) {
        return vec2.angle(a.vec, b.vec);
    }

    subtract(a: Vector2<T>, b: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    equalsApproximately(a: Vector2<T>, b: Vector2<T>) {
        return vec2.equalsApproximately(a.vec, b.vec);
    }
    equals(a: Vector2<T>, b: Vector2<T>) {
        return vec2.equals(a.vec, b.vec);
    }
    lerp(a: Vector2<T>, b: Vector2<T>, t: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    lerpV(a: Vector2<T>, b: Vector2<T>, t: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    max(a: Vector2<T>, b: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    min(a: Vector2<T>, b: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    mulScalar(v: Vector2<T>, k: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    divScalar(v: Vector2<T>, k: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    inverse(v: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
    ...
    cross(a: Vector2<T>, b: Vector2<T>, dst?: Vector3) {
        if (dst) {
            ...
            this.vec = vec2.cross(a.vec, b.vec,);
            return this;
        }
    }


    dot(a: Vector2<T>, b: Vector2<T>) {
    ...
    multiply(a: Vector2<T>, b: Vector2<T>, dst?: Vector3) {
        if (dst) {
            dst.vec = vec2.multiply(a.vec, b.vec, dst.vec);
            return dst;
        }
        else {
            this.vec = vec2.multiply(a.vec, b.vec,);
            return this;
        }
    }
    divide(a: Vector2<T>, b: Vector2<T>, dst?: Vector3) {
        if (dst) {
            dst.vec = vec2.divide(a.vec, b.vec, dst.vec);
            return dst;
        }
        else {
            this.vec = vec2.divide(a.vec, b.vec,);
            return this;
        }
    }
    ...
    transformMat4(m: Mat4, dst?: Vector2<T>) {
        if (dst) {
    ...
    transformMat3(m: Mat4, dst?: Vector2<T>) {
        if (dst) {
    ...
    rotate(b: Vector2<T>, rad: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    setLength(len: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    truncate(maxLen: number, dst?: Vector2<T>) {
        if (dst) {
    ...
    midpoint(b: Vector2<T>, dst?: Vector2<T>) {
        if (dst) {
