...
let shader = `
      ...
      @group(0) @binding(14) var<uniform> u_color12 : vec4f;

      @group(0) @binding(12) var ourSampler: sampler;
      @group(0) @binding(13) var ourTexture: texture_2d<f32>;
  ...
  uniforms: [
    {
      ...
      entries: [
        ...
        { binding: 12, resource: sampler ,label:"sampler=============="},
        { binding: 13, resource: texture.createView() ,label:"textureView==========="},
        {
          label: "test color",
          binding: 14,
          size: 4 * 4,
