...
export class WASDCamera extends CameraBase implements Camera {
  ...
  update( deltaTime: number,startTime:number,lastTime:number, input: Input): Mat4 {
    ...
    this.position = vec3.addScaled(position, this.velocity, deltaTime,startTime,lastTime);
...
export class ArcballCamera extends CameraBase implements Camera {
  ...
  update( deltaTime: number,startTime:number,lastTime:number, input: Input): Mat4 {
    ...
    // console.log(deltaTime,startTime,lastTime)
